...
if (~exist('modelParameters', 'var'))
    modelParameters = trainContinuousEstimator_kalman(trial, order, bin_size, selected_neurons);
end
...
% init
% CHEATING !
[modelParameters.angle] = deal(i_test_angle);
[modelParameters.isFirst] = deal(1);
%
...
for i_t = 1:n_points_estimated
    ...
    [x_e, y_e, modelParameters] = positionEstimator_kalman(test_data, modelParameters);
